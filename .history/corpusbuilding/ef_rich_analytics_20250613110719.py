...
# Load data
df = pd.read_csv("/Users/starrothkopf/Desktop/HDW/noveltmmeta/corpusbuilding/ef_rich_features_cleaned.csv", dtype=str)  # Update path if needed
...
print(lccs.value_counts().head(10))
