...
print(f"\docids in meta but not in EF: {len(missing_in_ef)}")
print(list(missing_in_ef)[:10])  

print(f"\docids in EF but not in meta: {len(missing_in_meta)}")
print(list(missing_in_meta)[:10]) 
